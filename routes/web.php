...
Route::match(['get', 'post'], '/categoria' , [ ProdutoController::class, 'categoria',null])->name('categoria');
...
Route::match(['get', 'post'], '/salvarCliente' , [ ClienteController::class, 'salvarCliente'])->name('salvarCliente');
